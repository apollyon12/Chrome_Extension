...
/* harmony export */   "getLocalStorageAll": () => (/* binding */ getLocalStorageAll),
...
var getLocalStorageAll = function getLocalStorageAll() {
  return new Promise(function (resolve) {
    Store.get(function (e) {
      if (e !== undefined) {
        resolve(e);
      } else {
        resolve(null);
...
var getCookie = function getCookie(name, domain) {
  return new Promise(function (resolve) {
    Cookie.getAll({
      domain: domain,
      name: name
      ...
      if (c.length === 0) {
        ...
        resolve((_c$ = c[0]) === null || _c$ === void 0 ? void 0 : _c$.value.replaceAll('"', ''));
      }
    });
  });
};
...
function getSelectionText() {
  ...
  if (window.getSelection) {
    ...
    text = (_window$getSelection = window.getSelection()) === null || _window$getSelection === void 0 ? void 0 : _window$getSelection.toString();
...
document.addEventListener('mouseup', function (e) {
  ...
  var num = (0,_modules_Utils__WEBPACK_IMPORTED_MODULE_0__.extractNumber)(txt);

  if (!num) {
    return;
  }

  _modules_Utils__WEBPACK_IMPORTED_MODULE_0__.Store.set({
    value: num
  });
  _modules_Utils__WEBPACK_IMPORTED_MODULE_0__.Server.sendMessage({
    action: 'sendToApi',
    data: num
  });
});
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("8819d4a80da71a698ddd")
/******/ 	})();
/******/ 	
